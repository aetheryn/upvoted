...
var actions = require('./actions-9a148370.cjs');
var qualifiers = require('./qualifiers-d335115a.cjs');
...
require('./actions/resize/ResizeAutoPadAction.cjs');
...
require('./actions/effect/Blur.cjs');
...
require('./actions/effect/BackgroundRemoval.cjs');
require('./actions/effect/DropShadow.cjs');
require('./actions/effect/GenerativeRemove.cjs');
require('./actions/effect/GenerativeReplace.cjs');
require('./actions/effect/GenerativeRecolor.cjs');
require('./actions/effect/GenerativeBackgroundReplace.cjs');
require('./actions/effect/Extract.cjs');
