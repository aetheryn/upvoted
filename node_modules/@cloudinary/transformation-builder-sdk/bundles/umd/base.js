    ...
    ***************************************************************************** */
    ...
    var FlagQualifier = /** @class */ (function (_super) {
        ...
        FlagQualifier.prototype.toString = function () {
            return _super.prototype.toString.call(this).replace(/\./g, '%2E');
        };
    ...
    var BackgroundColor = /** @class */ (function (_super) {
        ...
        function BackgroundColor(color) {
            var _this = _super.call(this) || this;
            _this._actionModel = {};
            _this.addQualifier(new Qualifier('b', new QualifierValue(prepareColor(color)).setDelimiter('_')));
    ...
    var Transformation$1 = /** @class */ (function () {
         ...
         * @return {this}
         */
        Transformation.prototype.format = function (format) {
    ...
    var Param = /** @class */ (function () {
        ...
        Param.prototype.serialize = function () {
            var val, valid;
            val = this.value();
            valid = Array.isArray(val) || isObject$1(val) || isString(val) ? !isEmpty(val) : val != null;
    ...
    var LayerParam = /** @class */ (function (_super) {
        ...
        LayerParam.prototype.value = function () {
            ...
            else if (isObject$1(this.origValue)) {
    ...
    var AutoFocus = /** @class */ (function (_super) {
        ...
        AutoFocus.focusOn = function (obj, weight) {
            var focusOn = obj instanceof FocusOnValue ? obj : new FocusOnValue(obj);
    ...
    var BackgroundGenerativeFillQualifier = /** @class */ (function (_super) {
        __extends(BackgroundGenerativeFillQualifier, _super);
    ...
    function createGenerativeFillBackgroundModel(background) {
        return __assign({ backgroundType: background.getBackgroundType() }, (background.getPrompt() ? { prompt: background.getPrompt() } : {}));
    }
    /**
    ...
    var RectangleRegion = /** @class */ (function (_super) {
        __extends(RectangleRegion, _super);
        /**
        ...
        function RectangleRegion(x, y, width, height) {
            var _this = _super.call(this) || this;
            _this.addQualifier(new Qualifier("x", x));
            _this.addQualifier(new Qualifier("y", y));
            _this.addQualifier(new Qualifier("w", width));
            _this.addQualifier(new Qualifier("h", height));
            _this._actionModel = {
                x: x,
                y: y,
                width: width,
    ...
    var Quality = { auto: auto$6, autoBest: autoBest, autoEco: autoEco, autoGood: autoGood, autoLow: autoLow, jpegmini: jpegmini, jpegminiBest: jpegminiBest, jpegminiHigh: jpegminiHigh, jpegminiMedium: jpegminiMedium };
    ...
    var AnimatedFormat = { auto: auto$3, gif: gif, webp: webp, png: png };
    ...
    var Source = { image: image, text: text, video: video, subtitles: subtitles, fetch: fetch, audio: audio };
    ...
    function createGenerativeFillBackground(background, backgroundModel) {
        var prompt = backgroundModel.prompt;
        if (prompt) {
        ...
        BorderAction.fromJson = function (actionModel) {
            ...
            if (radius) {
                var roundCornersAction = (function () {
                    ...
                    if (Array.isArray(radius)) {
                        return (_a = new RoundCornersAction()).radius.apply(_a, radius);
                    }
                    return undefined;
                })();
    ...
    var BlurAction = /** @class */ (function (_super) {
        ...
        BlurAction.prototype.prepareQualifiers = function () {
             ...
             */
            var _this = this;
            var strength = this._strength ? ":" + this._strength : '';
            if ('_region' in this) {
        ...
        BlurAction.fromJson = function (actionModel) {
            var _a = actionModel, strength = _a.strength, region = _a.region;
            // We are using this() to allow inheriting classes to use super.fromJson.apply(this, [actionModel])
            // This allows the inheriting classes to determine the class to be created
    ...
    var Pixelate = /** @class */ (function (_super) {
        ...
        Pixelate.fromJson = function (actionModel) {
            var _a = actionModel, region = _a.region, squareSize = _a.squareSize;
            // We are using this() to allow inheriting classes to use super.fromJson.apply(this, [actionModel])
            // This allows the inheriting classes to determine the class to be created
    ...
    var BackgroundRemoval = /** @class */ (function (_super) {
        __extends(BackgroundRemoval, _super);
    ...
    var GenerativeRemove = /** @class */ (function (_super) {
        __extends(GenerativeRemove, _super);
        ...
        GenerativeRemove.prototype.prepareQualifiers = function () {
            var qualifierValue = new QualifierValue().setDelimiter(";");
            switch (true) {
    ...
    var GenerativeReplace = /** @class */ (function (_super) {
        __extends(GenerativeReplace, _super);
    ...
    var GenerativeRecolor = /** @class */ (function (_super) {
        __extends(GenerativeRecolor, _super);
    ...
    var GenerativeBackgroundReplace = /** @class */ (function (_super) {
        __extends(GenerativeBackgroundReplace, _super);
    ...
    var Effect = {
        ...
        generativeRestore: generativeRestore,
        upscale: upscale,
        theme: theme,
        enhance: enhance,
        extract: extract
     ...
     */
    var getAuto = function (value) { return value === 'auto' ? value : null; };
