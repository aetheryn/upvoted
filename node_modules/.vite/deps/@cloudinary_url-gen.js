import {
  ...
  Underlay,
  VideoEdit
} from "./chunk-A2QVJE5D.js";
import "./chunk-ORXVEDXM.js";
import "./chunk-QTG7A7KU.js";
import {
  Background
} from "./chunk-FGRTQY2H.js";
import "./chunk-GDUEXEIC.js";
import {
  TextAlignment
} from "./chunk-IKVWM7SY.js";
import "./chunk-UOU56KAB.js";
import {
  Gravity
} from "./chunk-B5IJHQGG.js";
import "./chunk-FKJU6Q2T.js";
import {
  __export
...
var TextLayer = class extends layer_default2 {
   ...
   */
  toString() {
    var components, hasPublicId, hasStyle, publicId, re, res, start, style, text2, textSource;
    ...
    if (this.options.text != null) {
      ...
      while (res = re.exec(textSource)) {
        text2 += smartEscape2(textSource.slice(start, res.index));
        text2 += res[0];
        start = res.index + res[0].length;
      }
      text2 += smartEscape2(textSource.slice(start));
    }
    ...
    if (layer.resource_type === "fetch" || layer.url != null) {
      ...
      if ((!text2 || text2.length === 0) && resource_type !== "text") {
        ...
        if (text2 && text2.length >= 0) {
          ...
          text2 += encodeURIComponent(textSource.slice(start));
        }
      }
